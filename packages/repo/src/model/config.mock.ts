import { type ConfigKey, type ConfigUid } from "./config.ts";
import { newConfigAppId } from "./config-schema.ts";
import { type RecordFieldDef, titleFieldKey } from "./record-schema.ts";
